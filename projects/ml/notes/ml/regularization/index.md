...
- 特徴量がたくさんあって、本当に効いている数個に絞りたい（[次元の呪い](../curse-of-dimensionality/) 対策にも有効） → L1
...
- 特徴量がスケーリングされているか: L1/L2 はパラメータの大きさにペナルティを課すので、特徴量のスケールが揃っていないと一部の特徴ばかり罰せられる。前段に[標準化](../standardization/)（StandardScaler）を入れるのが基本
