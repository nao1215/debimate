...
3 つとも k=3 を指していて、技術的には k=3 で裏取りが取れている状態と考えられます。`k=2` の elbow も大きく下がっているように見えるが、silhouette と DB の両方が k=3 で改善するため、k=3 を採用する判断ができます。
...
- クラスタサイズ・密度が大きく違うデータ → DBSCAN や HDBSCAN
