...
作られた取引は、参加者から参加者へ転送されて Bitcoin のネットワーク全体へ広まります。各参加者は、受け取った取引をまだブロックに入っていない取引の置き場（[mempool](../mempool/)）に溜めます。この時点の取引は、共有された履歴のどこにも位置を持っていません。
...
上図の最後まで進んで初めて、Bob は支払いがブロックに入ったと確認できます。取引を作って送信しただけの段階では、mempool の混み具合と手数料の相場によっては、長く取り込まれない事もあります。各段階で何が確かめられ、どの仕組みが働くのかを 1 件の送金で追う説明は、[Bitcoin Transaction Lifecycle](../bitcoin-transaction-lifecycle/) にあります。
