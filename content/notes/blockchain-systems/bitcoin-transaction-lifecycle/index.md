...
チェーンの末尾は一時的に分岐する事があり、外れた列に入っていた取引は mempool に戻ります。そのため、取り込まれた直後の取引は確定ではなく確定に向かう状態です。何個待てば十分かは、金額とリスクの許容度で変わります。分岐の解消と確認数の扱いは [Bitcoin Block](../bitcoin-block/) で説明しています。
