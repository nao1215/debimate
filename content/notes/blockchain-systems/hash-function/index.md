...
衝突だけ桁が小さいのは、多数の入力のハッシュ値を溜めながら「どれか 2 つが一致する」のを待てるからです。23 人集まると誕生日が重なる組が半数の確率で生じる、という誕生日のパラドックスと同じ数え方で、n ビットの出力に対しておよそ 2 の n/2 乗回の試行で衝突が見つかりやすくなります。それでも 2 の 128 乗回は、計算機を並べても現実的な時間では終わらない回数です。
