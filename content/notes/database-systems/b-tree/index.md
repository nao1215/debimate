...
キーを挿入していくと、いずれかの葉が満杯になります。B-Tree は、満杯になったノードを 2 つへ分割して空きを作ります。PostgreSQL は、この操作が[「moving a portion of the items to a new page」（項目の一部を新しいページへ移す）事で、あふれたページに空きを作ると説明しています](https://www.postgresql.org/docs/current/btree.html)。
