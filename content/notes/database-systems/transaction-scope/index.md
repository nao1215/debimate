...
DB の更新と同じトランザクションでメッセージを記録し、後から配送する方法は Transactional Outbox と呼ばれ、[Domain Event](../../software-architecture/domain-event/) で扱っています。ここでの依頼の行が、そこで言う outbox テーブルの 1 行です。
