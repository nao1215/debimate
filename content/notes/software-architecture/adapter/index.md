...
この名前は、Brendan Burns 氏が 2015 年 6 月 29 日に公開したブログ「[The Distributed System ToolKit: Patterns for Composite Containers](https://kubernetes.io/blog/2015/06/the-distributed-system-toolkit-patterns/)」で、Sidecar・Ambassador と並ぶ 3 つのパターンの 3 つ目として紹介されました。同ブログは Adapter を「出力を標準化し、正規化する」と説明されています。
