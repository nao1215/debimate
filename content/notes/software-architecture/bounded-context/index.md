...
Evans 氏は書籍『Domain-Driven Design』（2003 年）の第 14 章で、大規模なシステムでドメインモデルを完全に統一する事は、実現可能でも費用対効果に見合うものでもない、と書いています。統一を諦める代わりに置くのが境界です。
...
Fowler 氏は、境界を決める要因として支配的なのは人間の文化だと説明しています。モデルがユビキタス言語として働く以上、言葉が変われば別のモデルが要るためです。用語の一覧を作り、同じ語に 2 つ以上の説明が付く場所を探すと、境界の候補が出てきます。
