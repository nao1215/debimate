...
{{< figure src="hamburger.webp" alt="KUA`AINA のチーズバーガー" >}}
{{< /figures >}}
...
{{< figures height="20rem" >}}
{{< figure src="compass.webp" alt="シンドバッドのアトラクションに登場するクジラと船" >}}
{{< figure src="Rapunzel.webp" alt="ラプンツェルのエリアに貼られたフリン・ライダーの手配書" >}}
{{< /figures >}}
...
{{< figures height="20rem" >}}
{{< figure src="pooh.webp" alt="プーさんのハニーハントの絵本をかたどった外観" >}}
{{< /figures >}}
