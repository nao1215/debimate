...
- tsv
cover:
  image: images/Screenshot-from-2022-12-02-22-41-58.webp
...
[![nao1215/sqly の GitHub リポジトリカード（star 24・fork 0）](images/sqly.webp)](https://github.com/nao1215/sqly)
...
[![noborus/trdsql の GitHub リポジトリカード（star 1k・fork 52）](images/trdsql.webp)](https://github.com/noborus/trdsql)[![harelba/q の GitHub リポジトリカード（star 9k・fork 401）](images/q.webp)](https://github.com/harelba/q)[![mithrandie/csvq の GitHub リポジトリカード（star 1k・fork 50）](images/csvq.webp)](https://github.com/mithrandie/csvq)[![dinedal/textql の GitHub リポジトリカード（star 8k・fork 308）](images/textql.webp)](https://github.com/dinedal/textql)
...
![sqly の階層構造図。上から sqly shell、sqly helper command、data import/exporter と sql executor、file reader/writer と SQLite3](images/sqly-1.webp)
...
![sqly のパッケージ依存グラフ。di を起点に shell・usecase・infrastructure を経て domain/model へ依存が向かう](images/dependency.webp)
...
![csv/tsv/ltsv/json の各ファイルをそれぞれのモデルへ読み込み、共通の table model へ集約するデータフロー図](images/sqly-ページ2.webp)
...
![sqly シェルモードの端末画面。.help でヘルパーコマンド一覧を表示し、.mode ltsv や SELECT * FROM user、.tables、.header user を実行した結果と SQL キーワードの補完候補](images/Screenshot-from-2022-12-02-22-41-58.webp)
