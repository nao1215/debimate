...
- /2026/07/04/cliにブラックボックステストe2eを行うatagoを作った話/
- /post/2026-07-04-cliにブラックボックステストe2eを行うatagoを作った話/
- /2026/07/05/CLIにブラックボックステストE2Eを行うatagoを作った話/
- /2026/07/05/cliにブラックボックステストe2eを行うatagoを作った話/
---
...
私が CLI の E2E にこだわる理由は、過去の経験が関係しています。昔、「出力するファイルの形式を変えただろう。外部仕様を勝手に変えるな。ファイルもインターフェースで、他のアプリが使う」と怒られたことがあり、あらゆる出力をテストしたい気持ちが強くなりました。
