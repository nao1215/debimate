...
本記事では、[Claude のプログラム](https://claude.com/contact-sales/claude-for-oss)に応募した際の申請文を共有します。申請から1ヶ月ほど経ちましたが返事はなく、サイレント不採択ではないかと予想しています。

（単純に、申し込んだ内容が目を見張る OSS 活動ではなかった、と考えています）
...
2026/09/22追記：gup をメインに据えて、Codex for Open Source プログラムに応募しました。 
