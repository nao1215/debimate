...
cover:
  ...
  hidden: false
aliases:
- /post/2020-01-13-review：新装版　リファクタリング　既存のコードを/
- /2020/01/13/review：新装版　リファクタリング　既存のコードを/
- /2020/01/13/review新装版-リファクタリング-既存のコードを/
- /post/2020-01-13-review新装版-リファクタリング-既存のコードを/
- /2020/01/14/review：新装版　リファクタリング　既存のコードを/
- /2020/01/14/review新装版-リファクタリング-既存のコードを/
---
